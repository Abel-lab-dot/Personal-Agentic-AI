...
1.  **Copy and Paste:** Replace the entire content of your `app.py` file with the code above.
2.  **Save and Commit:** Save the file, then commit and push the changes to your GitHub repository.
3.  **Deploy:** Go to your Render dashboard and manually deploy the latest commit.

Once the new deployment is live, your AI assistant will respond with the new structured and easy-to-read format.